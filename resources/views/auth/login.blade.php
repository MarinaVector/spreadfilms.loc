    ...
    <div class="row page-register bg-white">
        <div class="offset-lg-2 col-xl-4 col-xl-3 px-5 mt-md-5 col-12 from_menu_margin">
                ...
                <form method="POST" action="/login">
                    ...
                    <div class="form-group">
                        <label for="password" class="font-weight-bold">Password</label> <small class="float-right"><a
                                href="/password/reset" tabindex="-1" title="Forgot Password"
                                class="forgot-password-link">Forgot
                                Password</a></small>
            ...
            <div class="box-register text-center">
                ...
                <hr>
                <p>Everything is new with us! If your registration from a previous version does not work, you can use
                    the
