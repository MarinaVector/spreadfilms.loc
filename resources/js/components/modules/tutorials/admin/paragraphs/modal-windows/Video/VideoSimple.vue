            ...
            <div class="col-md-8">
                <div class="edit-view">
                    <div class="edit-inner">
                        ...
                        <div class="buttons mt-5 video-btn">
                            <div class="btn btn-primary save-btn"><span class="button-inner">
            Save
        </span></div>
                            <div class="btn btn-secondary cancel-btn" data-dismiss="modal"><span class="button-inner">
            Chancel
        </span></div>
                        </div>
                    </div>
