<template>
    <div class="modal fade" id="TextModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    export default {
        ...
        data() {
            return {
                ...
                NormalTextBody: this.$props.text ? this.$props.text : '<p></p>',
                editorConfig: {
        ...
        methods: {
            save: function () {
                this.$emit('saveData', null, this.NormalTextBody)
            },
            cancel: function (event) {
                if(event.target.id === 'TextModal' || event.target.id === 'CancelModal') {
                    this.NormalTextBody = this.$props.text;
                }
            },
        },
        computed: {
