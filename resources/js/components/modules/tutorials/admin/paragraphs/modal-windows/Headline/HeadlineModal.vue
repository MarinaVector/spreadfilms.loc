<template>
    <div class="modal fade" id="HeadlineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    export default {
        ...
        methods: {
            ...
            cancel: function (event) {
                if(event.target.id === 'HeadlineModal' || event.target.id === 'CancelModal') {
